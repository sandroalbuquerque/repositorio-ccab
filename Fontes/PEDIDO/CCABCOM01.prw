...
ฑฑบPrograma  ณ FER052   บAutor  ณ Valdemir Jos้      บ Data ณ  04/05/2012 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณImprimir Pedido de Compras Grafico                          บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Especifico SP / CCAB                                       บฑฑ
...
//User Function CCABCOM01(pcPedido)
	...
	If lAuto    //!Empty(pcPedido)      //        
       ...
       // Efetua o calculo para saber o total de paginas que existirแ
	...
	Else
	 ...
	 // Chama parametro que irแ pedir o numero do pedido
     AADD(aPerg,{1,"Pedido Nบ "     	,Space(TamSx3("C7_NUM")[1])	     ,""	,""	,""		,""	,0	,.F.})
     AADD(aPerg,{1,"Filial    "     	,Space(TamSx3("C7_FILIAL")[1])  ,""		,""	,"SM0"	,""	,0	,.F.})
	 
	 if ParamBox(aPerg,"Impressao de Pedido de Compras",,,,,,,,"",.T.,.T.)

	   cSql := " AND C7_NUM ='"+MV_PAR01+"' " // AND C7_NUM <='"+MV_PAR02+"' "  Alterado conforme solicita็ใo REjiane 30/05/12
...
Static Function IMPRIME(cPedDe, cPedAte,pTipo, pcFil)
    ...
    // Monta query para impressใo do relat๓rio
	...
	If !TRB->(Eof())
		...
		While !TRB->(Eof())
			...
			If SC7->( MsSeek(_cFilial + cPedDe) )
				...
				While !Eof() .And. SC7->C7_NUM == cPedido .AND. SC7->C7_FILIAL == _cFilial
					...
					//cCodObs := Posicione("SB1",1,xFilial("SB1") + SC7->C7_PRODUTO, "B1_CODOBS") Removido por solicita็ใo Rejiane informou que tem que ser pego
				    //	                                                                              a observa็ใo do C7_OBS REUNIรO DE 30/05/2012
					...
					if pTipo = 'I'
						// Faz Impressใo dos Dados do Pedido					
						...
						oPrinึt:Say(nLin+nDif,1680+nAj_G+nAj+nDif,Transform(SC7->C7_VALIPI,"@E 999,999.99"),oFont3,,,,1)
					...
					If nLin > nMaxLin
						oPrint:Line(nLin+nGrafico,70,nLin+nGrafico,2320)                         // Tra็o
               ...
               if pTipo='I'
				...
				if pTipo = 'I'                                      
					...
					oPrint:Say(nLin+20,  1100,"OBSERVAวรO"  ,oFont5b,,CLR_WHITE)
				endif 
			    // Carrega Observa็๕es
		...
		Enddo
	Else
		Aviso("Aviso","Nใo Existem dados a Serem Impressos, nos parametros Informados...",{"Ok"},2)
	EndIf
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณImpCabec  บAutor  ณValdemir Jos้       บ Data ณ  05/05/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Cabe็alho do Pedido de Compra                              บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ CCAB                                                       บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
Static Function ImpCabec(pxTipo, pTipo)
	...
	if pTipo = 'I'
		...
		oPrint:Say(nProw, 2080, "Nฐ "+cPedido ,oFontT)          //SC7->C7_NUM
	Endif	                                          
	nProw +=  150 //210                       
	  
	if pTipo = 'I'
		// Quadros [Solicita็ใo, Cota็ใo, Data
		//oPrint:Box(nProw, 070,nProw+50,550)       // Solicita็ใo
		//oPrint:Box(nProw,1000,nProw+50,1460)      // Cota็ใo
		oPrint:Box(nProw,1760,nProw+50,2320)      // Data
		oPrint:Line(nProw, 2110, nProw+50, 2110)  // Divisใo
	endif
	nProw += 10
	if pTipo = 'I'
		//oPrint:Say(nProw,100, "Nฐ SOLICITAวรO",oFont5)
		//oPrint:Say(nProw,400, cNumSC   ,oFont5b)
	
		//oPrint:Say(nProw,1040, "Nฐ COTAวรO"   ,oFont5)
	...
	if pTipo = 'I'
		...
		oPrint:Say(nProw, 600, "RAZรO SOCIAL:"       , oFont5)
	...
	// Campos
	if pTipo = 'I'
		oPrint:Say(nProw, 100, "ENDEREวO:"           , oFont5)
	...
	if pxTipo = 1
		...
		// Campos
		if pTipo = 'I'
			oPrint:Say(nProw, 100, "RAZรO SOCIAL:"             , oFont5)
			oPrint:Say(nProw,1000, "ENDEREวO:"                 , oFont5)
		...
		nProw += 50
		if pTipo = 'I'
			oPrint:Say(nProw, 100, "MUNICอPIO:"                , oFont5)
		...
		if pTipo = 'I'                                      
			...
			oPrint:Say(nProw+20, 850,"OBSERVAวรO TAXA"  ,oFont5b,,CLR_WHITE)
			oPrint:Say(nProw+20, 1850,"TIPO LANวAMENTO",oFont5b,,CLR_WHITE)
		endif	                                
		...
		IF !EMPTY(_cTIPO)				// Acrescentado por Valdemir Jose 30/01/2013
			cObs01 := if(_CTIPO='CAP',_CTIPO+'-Contra Apresenta็ใo',_CTIPO+'-Encontro de Contas ')+' Data: '+dtoc(SC7->C7_XDTENCC)
		ENDIF
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ FUNCTION MONTAQUERY (FAZ A SELECAO DOS REGISTROS)      ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณImpRodape บAutor  ณValdemir Jos้       บ Data ณ  09/05/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Assinatura dos aprovadores                                 บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Ferreira Guedes                                            บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function ImpRodape(nLin, nEspaco, nAj_G, nAj, nDif, pTipo)
	...
	IF dbSeek(xFilial('SC8')+cNUMCOT)
		cComprador  := SC8->C8_XUSUANA      // Criar ponto de entrada aa analise de cota็ใo e gravar o cUserName em algum campo especifico.
    ENDIF
	*/
    ...
    if pTipo = 'I'
		...
		oPrint:Say(nLin+20, 850,"APROVAวรO FERREIRA GUEDES",oFont3,,CLR_WHITE)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณImpObservacoes บAutor  ณValdemir Jose  บ Data ณ  09/05/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Imprime as Duas Observa็๕es Pedido e Tabela de             บฑฑ
ฑฑบ          ณ Condi็๕es Gerais                                           บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Ferreiga Guedes                                            บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function ImpObservacoes(nLin, nEspaco, nAj_G, nAj, nDif,pTipo,pcFilial)
	...
	// Prepara Informa็๕es de Condi็๕es Gerais
		...
		For nxReg := 1 To Len(aCGerais)
			...
			if nxReg = 1                                       
				if pTipo = 'I'
					...
					oPrint:Say(nLin+20, 1020,"C O N D I ว ี E S  G E R A I S"   ,oFont3,,CLR_WHITE)
				endif
				nLin += 70 
			Endif
			if pTipo = 'I'
	...
	If bEncontrou
	   ...
	   aObsProd := TrataMemo(cMEMO, 115)
		...
		if pTipo = 'I'
			...
			oPrint:Say(nLin+20, 1040,"O B S E R V A ว ี E S"   ,oFont3,,CLR_WHITE)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFER052    บAutor  ณValdemir Jos้       บ Data ณ  14/05/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Monta Condi็๕es Gerais                                     บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Ferreira Guedes                                            บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณRemoveCaracter   บAutor  ณValdemir Joseบ Data ณ  15/05/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
ฑฑบPrograma  ณFER052    บAutor  ณValdemir Jos้       บ Data ณ  14/05/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Atualiza Campo C7_XOBSPED                                  บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
User Function GetObsPed(pcPedido, pcXOBSPED)
	...
	//ณ Grava a descricao do metodo no campo memo do Siga (SYP).     ณ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFER052    บAutor  ณValdemir Jos้       บ Data ณ  16/05/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Imprime Observa็๕es no corpo do pedido de venda            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Ferreira Guedes                                            บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
Local nX := 0
	...
	// Impressใo das colunas grแficas do corpo do pedido
	if pTipo = 'I'
		ImprimeColunas(oPrint, cMemo, nLin, nEspaco, nDif, nAj_G, nAj) 
	Endif
	nLin += 30
	For nX := 1 To Len(aObsProd)                        
		// Faz impressใo da Observa็ใo com colunas
		if pTipo = 'I'
...
ฑฑบPrograma  ณFER052    บAutor  ณValdemir Jos้       บ Data ณ  16/05/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Imprime as colunas do Pedido de Compra                     บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
Static Function ImprimeColunas(oPrint, cMemo, nLin, nEspaco, nDif, nAj_G, nAj) 
	...
	oPrint:Line(nLin,397+nAj_G,nLin+nEspaco,397+nAj_G)  		  // Descri็ใo
	...
	oPrint:Line(nLin,1246+nAj_G+nAj,nLin+nEspaco,1246+nAj_G+nAj)  // Pre็o Unitแrio
...
ฑฑบPrograma  ณFER052    บAutor  ณValdemir Jos้                      บ Data ณ  15/05/12 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯออออออออออออออออออออออออออนฑฑ 
ฑฑบDesc.     ณ  Esta funcao trata a informacao contida em um campo memo, respeitando a บฑฑ
ฑฑบ          ณ  quebra de linha e o numero de caracteres por linha.                    บฑฑ
ฑฑบ          ณ  Retorna um array com as informacoes para impressao.                    บฑฑ 
...
ฑฑบPrograma  ณFER052    บAutor  ณValdemir Jos้       บ Data ณ  16/05/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Desc.     ณ Esta funcao verifica somente se existe a quebra de pagina,บฑฑ
ฑฑบ sendo que a cada quebra e adicionado uma posicao nova no			  บฑฑ
ฑฑบ array																  บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Ferreira Guedes                                            บฑฑ
...
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหอออออออออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFER052    บAutor  ณValdemir Jos้              บ Data ณ  16/05/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯออออออออออออออออออออนฑฑ
ฑฑบDesc.     ณ Apos ter sido verificado a quebra de pagina, agora e verificado a นฑฑ
ฑฑบ          ณ quantidade de caracteres por posicao do array, sendo que cada     นฑฑ
ฑฑบ          ณ posicao deve respeitar o numero de caracteres informado pelo      นฑฑ
ฑฑบ          ณ parametro														 นฑฑ
ฑฑบ          ณ                                                            		 บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFER052    บAutor  ณValdemir Jose       บ Data ณ  20/06/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Monta Query de Aprovadores                                 บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                        บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFER052    บAutor  ณValdemir Jos้       บ Data ณ  04/07/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Imprime Titulo do pedido                                   บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
Static Function ImpTitulos(pTipo, oPrint, nLin, nEspaco, nDif, nAj, nAj_G, nAj_Cod)
	...
	if pTipo = 'I'
		...
		oPrint:Say(nLin+nDif,080,"Nฐ",oFont3,,CLR_WHITE)
		...
		oPrint:Say(nLin+nDif,417+nAj_G,"DESCRIวรO",oFont3,,CLR_WHITE)
