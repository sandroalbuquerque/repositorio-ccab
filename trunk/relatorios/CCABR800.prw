...
ฑฑบPrograma  ณCABR800     บ Autor ณ Sandra Ribeiro    บ Data ณ  03/05/09   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Relat๓rio de notas fiscais de fretes x notas fiscais de saํda 
ฑฑบ          ณ Controle de saldo de empenho de MP usada                   บฑฑ
ฑฑบ          ณ em Ordem de Produ็ใo;                                      บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Cliente CCAB                                               บฑฑ
...
Local Cabec1       := "Fil Doc     Ser Esp Emissao    Est      Peso B.     Valor    TES  Tipo Nt Frete  Serie   Valor  Transp Descri็ใo                  Pedido Cliente   Descri็ใo                Hist๓rico"
Local Cabec2       := ""
Local imprime      := .T.
Local aOrd := {}
Private lEnd         := .F.
...
ElseIf mv_par09 = 2        //sele็ใo sem CTR
	cQuery := "SELECT DISTINCT SF2.F2_FILIAL FIL,SF2.F2_DOC DOCTO,SF2.F2_SERIE SER, SF2.F2_ESPECIE ESP, SF2.F2_TPFRETE TF,"
	cQuery += "(SUBSTRING(SF2.F2_EMISSAO,7,2)+'/'+SUBSTRING(SF2.F2_EMISSAO,5,2)+'/'+ SUBSTRING(SF2.F2_EMISSAO,1,4)) EMISSAO, SF2.F2_EST EST, SF2.F2_PBRUTO AS PBRUTO, "
...
//Local Cabec1       := "Fil Doc      Ser  Emissao  Est    Peso B.        Valor TES  Nt Frete  Ser     Valor     Transp   Descri็ใo                 Pedido   Cliente  Descri็ใo               Hist๓rico    "
