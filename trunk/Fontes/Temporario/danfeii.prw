...
#DEFINE MAXMENLIN  123    //080   - Trocado por Valdemir 28/01/13     // Máximo de caracteres por linha de dados adicionais
...
For nZ := 1 To nLenDet
	...
	aadd(aItens,{;
		SubStr(oDet[nX]:_Prod:_cProd:TEXT,1,nMaxCod+2),;
...
oDanfe:Box(721,000,855,351)    // 865
...
oDanfe:Box(721,350,855,603)       // 865
		...
		If nL > nMaxItemP2
			...
			*/
			...
			IF MV_PAR05 <> 1 .And. nMensagem <= nLenMensagens
				...
				oDanfe:Box(721+nLinhavers,000,855+nLinhavers,351)    // 865
				...
				oDanfe:Box(721+nLinhavers,350,855+nLinhavers,603)       // 865
...
If lMensagens
	...
	oDanfe:Box(172,000,855,351)     // 865
	oDanfe:Say(170,002,"INFORMAÇÕES COMPLEMENTARES",oFont08N:oFont)
	oDanfe:Box(172,350,855,603)     // 865
